...
class MyPurchasedItems extends StatefulWidget {
  @override
  _MyPurchasedItemsState createState() => _MyPurchasedItemsState();
}

class _MyPurchasedItemsState extends State<MyPurchasedItems> {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return FutureBuilder(
              future: AuthClass().getOrderDetails(orderIDs[index], orderDetails[index]),
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: AuthClass().getMyPurchased(),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
